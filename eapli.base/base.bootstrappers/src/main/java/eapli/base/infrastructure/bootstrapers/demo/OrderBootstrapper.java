...
public class OrderBootstrapper extends OrderBootstrapperBase implements Action {
    ...
    public boolean execute() {
        ...
        createOrder("Rua de casa do simões", new Shopping_Cart(1), new Shipment_Method(Shipment_Method.ShipmentMethod.EXPRESS), new Payment_Method(Payment_Method.PaymentMethod.CREDITCARD));
        createOrder("Rua de casa da Ana", new Shopping_Cart(1), new Shipment_Method(Shipment_Method.ShipmentMethod.NORMAL), new Payment_Method(Payment_Method.PaymentMethod.CREDITCARD));
        createOrder("Rua de casa do Sr.Miguel", new Shopping_Cart(1), new Shipment_Method(Shipment_Method.ShipmentMethod.NORMAL), new Payment_Method(Payment_Method.PaymentMethod.CREDITCARD));
        ...
        createOrder("Rua 8 de outubro", new Shopping_Cart(1), new Shipment_Method(Shipment_Method.ShipmentMethod.EXPRESS), new Payment_Method(Payment_Method.PaymentMethod.CREDITCARD));
        createOrder("Rua 9 de outubro", new Shopping_Cart(1), new Shipment_Method(Shipment_Method.ShipmentMethod.NORMAL), new Payment_Method(Payment_Method.PaymentMethod.CREDITCARD));
        createOrder("Rua 10 de outubro", new Shopping_Cart(1), new Shipment_Method(Shipment_Method.ShipmentMethod.NORMAL), new Payment_Method(Payment_Method.PaymentMethod.CREDITCARD));
        ...
        createOrder("Rua 12 de outubro", new Shopping_Cart(1), new Shipment_Method(Shipment_Method.ShipmentMethod.EXPRESS), new Payment_Method(Payment_Method.PaymentMethod.CREDITCARD));
        ...
        createOrder("Rua 16 de outubro", new Shopping_Cart(1), new Shipment_Method(Shipment_Method.ShipmentMethod.NORMAL), new Payment_Method(Payment_Method.PaymentMethod.CREDITCARD));
